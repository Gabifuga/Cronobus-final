                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     ...
                     <div class="color-quality">
                        <div class="color-quality-right">
                           ...
                           <h5><button type="button" onclick="location.href='<?php echo $row['Dimension']; ?>' "target="_blank" class="w-50 btn btn-lg btn-primary">link para o mapa</button></h5>
                     ...
                     <div class="occasional">
                        <h5>Motorista: <?php echo $row['Name'];?></h5>
                        <h5>Empresa : <?php echo $row['typename'];?></h5>                       
                       <h5>Marca do veículo : <?php echo $row['amname'];?></h5>
                       <h5>Placa do veículo : <?php echo $row['RefNum'];?></h5>

                       <h5>Tarifa : <?php echo $row['SellingPricing'];?></h5>
