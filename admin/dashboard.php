...
<head>
  <title>Cronobus - Painel Admin</title>
...
?>
             <i class="fa fa-user"></i>
              ...
              <div class="title"> <a class="dropdown-item" href="manage-artist.php">Motoristas totais</a></div>
            </div>
...
?>
              ...
              <div class="count"><?php echo $artcount;?></div>
             <div class="title"> <a class="dropdown-item" href="manage-art-type.php">Total Empresa</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
...
?>
              ...
              <div class="title"> <a class="dropdown-item" href="manage-art-medium.php">Marcas de veículos</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
