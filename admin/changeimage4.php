...
<head>
  ...
  <title>Atualizar imagem | Cronobus</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Atualizar imagem da linha</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">inicio</a></li>
              <li><i class="icon_document_alt"></i>Imagem da linha</li>
              <li><i class="fa fa-file-text-o"></i>Atualizar imagem da linha</li>
            </ol>
          </div>
        </div>
        <div class="row">
...
?>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Imagem anterior</label>
                    <div class="col-sm-10">
                      <img src="images/<?php echo $row['Image4'];?>" width="200" height="150">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Imagem nova</label>
                    <div class="col-sm-10">
