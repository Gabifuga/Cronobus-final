...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
echo "<script>alert('Empresa foi adicionada.');</script>";
...
<head>
  <title>Adicionar Empresa | Cronobus</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Adicionar Empresa</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Inicio</a></li>
              <li><i class="icon_document_alt"></i>Empresa</li>
              <li><i class="fa fa-file-text-o"></i>Adicionar Empresa</li>
            </ol>
          </div>
        </div>
        <div class="row">
