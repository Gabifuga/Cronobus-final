...
<head>
  ...
  <title>Sobre nós | Cronobus</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> Sobre nós</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Inicio</a></li>
              <li><i class="icon_document_alt"></i>Sobre nós</li>
              <li><i class="fa fa-files-o"></i>Sobre nós</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
...
?>
                  <form class="form-validate form-horizontal" method="post" action="">
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">Titulo da página <span class="required">*</span></label>
                      <div class="col-lg-10">
