...
<html lang="zxx">
   <head>
      <title>Cronobus | Página das linhas</title>
            ...
            <div class="side-bar col-lg-3">
                  <div class="search-hotel">
                     ...
                     <form action="search.php" method="post">
                        <input type="search" placeholder="Nomes das linhas..." name="search" required="">
                  ...
                  <!--preference -->
                  <div class="left-side">
                     <h3 class="agileits-sear-head">Empresas disponíveis</h3>
                     <ul>
                        <li>
                           <?php
...
?>
               ...
               <div class="left-ads-display col-lg-9">
                  ...
                  <?php
                  $cid=$_GET['cid'];
$ret=mysqli_query($con,"select tblarttype.ID as atid,tblarttype.ArtType as typename,tblartproduct.ID as apid,tblartproduct.Title,tblartproduct.Image,tblartproduct.ArtType, tblartproduct.Size, tblartproduct.Dimension,tblartproduct.Orientation,tblartproduct.Description from tblartproduct join tblarttype on tblarttype.ID=tblartproduct.ArtType where tblartproduct.ArtType='$cid'");
$cnt=1;
...
<h3 align="center" style="color:red;">Nenhuma linha ou rota encontrada</h3>
                     <?php } ?>
